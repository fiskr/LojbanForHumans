...
\DeclareUnicodeCharacter{0294}{ʔ}

% IMPORTANT: If you use gb4e package, let it be the last \usepackage call in the document's preamble. 
% Otherwise you may get exceeded parameter stack size error.
\usepackage{gb4e}
...
\bibitem{Hassler2002}
	...
	Ch. 7, 
	pp. 143-172.
	% G{\"u}ldemann, Tom and von Roncador, Manfred.
...
\begin{description}
	\item[ ] \textbf{ja'o} I conclude
	\item[ ] \textbf{ca'e} I define
	\item[ ] \textbf{ba'a} I expect \textbar {} I experience \textbar {} (opposite) I remember
	\item[ ] \textbf{su'a} I generalize \textbar {} (opposite) I particularize
	\item[ ] \textbf{ti'e} I hear (by hearsay)
	\item[ ] \textbf{ka'u} I know by cultural means
	\item[ ] \textbf{se'o} I know by internal experience
	\item[ ] \textbf{za'a} I observe (directly, with senses)
	\item[ ] \textbf{pe'i} I opine
